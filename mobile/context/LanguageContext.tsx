...
const translations = {
  en: {
    ...
    discover: { subtitle: "Explore AI models & skills", availableModels: "Available Models", comingSoonTitle: "LucyHub coming soon", comingSoonSubtitle: "Marketplace for AI agent skills" },
  ...
  zh: {
    ...
    discover: { subtitle: "探索 AI 模型和技能", availableModels: "可用模型", comingSoonTitle: "LucyHub 即将上线", comingSoonSubtitle: "AI 技能市场" },
  ...
  ja: {
    ...
    discover: { subtitle: "AIモデルとスキルを探索", availableModels: "利用可能なモデル", comingSoonTitle: "LucyHub 近日公開", comingSoonSubtitle: "AIスキルマーケットプレイス" },
  ...
  ko: {
    ...
    discover: { subtitle: "AI 모델과 스킬 탐색", availableModels: "사용 가능한 모델", comingSoonTitle: "LucyHub 출시 예정", comingSoonSubtitle: "AI 스킬 마켓플레이스" },
