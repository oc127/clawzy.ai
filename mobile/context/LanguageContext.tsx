...
const translations = {
  en: {
    ...
    tabs: { home: "Chat", status: "Status", memory: "Memory", settings: "Settings" },
  ...
  zh: {
    ...
    tabs: { home: "聊天", status: "状态", memory: "记忆", settings: "设置" },
  ...
  ja: {
    ...
    tabs: { home: "チャット", status: "ステータス", memory: "メモリー", settings: "設定" },
  ...
  ko: {
    ...
    tabs: { home: "채팅", status: "상태", memory: "기억", settings: "설정" },
