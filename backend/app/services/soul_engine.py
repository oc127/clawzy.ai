...
# ─── Default Soul ───
# Canonical personality: gentle Chinese girlfriend + capable secretary.
# Source of truth lives in personality_engine.LUCY_PERSONALITY so onboarding,
# proactive messaging, and soul_engine all share one definition.

DEFAULT_SOUL = LUCY_PERSONALITY
