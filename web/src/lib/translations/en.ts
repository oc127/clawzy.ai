const en = {
  ...
  settings: {
    ...
    budgetDesc: "Set a daily credit limit to control spending. When the limit is reached, your agents will pause until the next day.",
    dailyLimit: "Daily Credit Limit",
    dailyLimitHint: "Leave empty or 0 to remove the limit.",
    saveLimit: "Save Limit",
    removeLimit: "Remove Limit",
    limitSet: "Daily limit set",
    limitRemoved: "Daily limit removed",
    todayUsage: "Today's usage",
    limitReached: "Daily limit reached. Agents paused until tomorrow.",
