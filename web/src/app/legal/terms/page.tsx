        ...
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-extrabold">
              <span className="text-[#ff385c]">Lucy</span>
            </span>
          </Link>
...
function TermsJa() {
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <h2>第1条（適用）</h2>
      <p>
        本利用規約（以下「本規約」）は、Lucy（以下「当社」）が提供するAIエージェントプラットフォームサービス（以下「本サービス」）の利用条件を定めるものです。ユーザーは本規約に同意の上、本サービスを利用するものとします。
      </p>
      ...
      <p className="text-sm text-[#717171]">
        ご質問がある場合は、support@thelucy.ai までお問い合わせください。
      </p>
    </article>
  );
}
...
function TermsEn() {
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <p>
        By creating an account or using Lucy (the &quot;Service&quot;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.
      </p>
      ...
      <ul>
        ...
        <li>LucyHub skill marketplace</li>
      </ul>
      ...
      <ol>
        <li>All intellectual property rights in the Service belong to Lucy.</li>
      ...
      <hr />
      <p className="text-sm text-[#717171]">
        Questions? Contact us at support@thelucy.ai.
      </p>
    </article>
  );
}
